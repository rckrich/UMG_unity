...
{
    public bool HasUMGCollection(string _walletAddres)
    {
        try
        {
            var client = new RestClient("https://testnets-api.opensea.io/api/v1/collections?asset_owner=" + _walletAddres + "&offset=0&limit=300");
